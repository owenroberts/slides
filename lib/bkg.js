var BKG = function( p ) {
	...
	p.setup = function() {
		...
		var oppSeed = (seed + 50) % 100;
		p.aliveOpp = p.color(oppSeed, sat + 10, br + 10);
		p.bornOpp = p.color(oppSeed + change, sat + 10, br + 10);
		p.diedOpp = p.color(oppSeed - change, sat + 10, br + 10);
		p.nothingOpp = p.color(oppSeed + change/2, sat + 10, br + 10);
